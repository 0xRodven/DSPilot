...
const features = [
      ...
      <div className="absolute inset-0 flex items-center justify-center opacity-30">
        <div className="grid grid-cols-4 gap-2 p-8">
          {[0.6, 0.8, 0.7, 0.9, 0.65, 0.85, 0.75, 0.55, 0.7, 0.8, 0.6, 0.9, 0.7, 0.8, 0.65, 0.75].map((opacity, i) => (
            <div
              key={i}
              className="h-8 w-8 rounded bg-blue-500/20"
              style={{ opacity }}
            />
          ))}
        </div>
  ...
  },
  {
    ...
    description:
      "Identifiez les erreurs récurrentes et leurs causes pour améliorer la qualité des livraisons.",
  ...
  },
  {
    ...
    description:
      "Planifiez des sessions de coaching ciblées basées sur les données de performance.",
  ...
  },
  {
    ...
    description:
      "Suivez l'évolution de chaque livreur avec des profils détaillés et un historique complet.",
  ...
  return (
    <section id="features" className="py-20 md:py-32">
      <AnimationContainer className="mb-12 text-center">
        <span className="text-sm font-medium text-blue-500">Fonctionnalités</span>
        ...
        <p className="mx-auto mt-4 max-w-2xl text-lg text-muted-foreground">
          DSPilot vous offre tous les outils nécessaires pour optimiser les performances
          de votre station DSP Amazon.
        </p>
      </AnimationContainer>
