  ...
  return (
    <Card className="border-border bg-card">
      <CardHeader className="pb-3">
        <CardTitle className="font-medium text-base">Top Drivers - Plus d'erreurs</CardTitle>
        ...
        <p className="mt-3 text-muted-foreground text-sm">
          Ces {drivers.length} drivers = <span className="font-medium text-foreground">{top5Percentage}%</span> des{" "}
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="mt-2 flex gap-2">
                      <Button variant="outline" size="sm" className="h-7 bg-transparent text-xs" asChild>
