  ...
  return (
    <Card className="bg-card/50 border-border/50">
      <CardHeader className="pb-3">
        <CardTitle className="text-base font-medium">Couverture des données</CardTitle>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2">
          <p className="text-xs text-muted-foreground">Q{currentQuarter}</p>
        ...
        <div className="grid grid-cols-3 gap-3">
          <div className="rounded-lg bg-muted/30 p-3 text-center">
            ...
            <p className="text-xs text-muted-foreground">Semaines importées</p>
            <p className="text-xs text-muted-foreground">Q4 {year}</p>
          </div>
          <div className="rounded-lg bg-muted/30 p-3 text-center">
          ...
          <div className="rounded-lg bg-muted/30 p-3 text-center">
            ...
            <p className="text-xs text-muted-foreground">Semaines manquantes</p>
          </div>
        </div>
        ...
        {failed.length > 0 && (
          <div className="flex items-center gap-2 p-3 rounded-lg bg-amber-500/10 border border-amber-500/20">
            ...
            <Button variant="ghost" size="sm" className="text-xs text-amber-400 shrink-0">
              Ré-importer
            </Button>
          </div>
        )}
