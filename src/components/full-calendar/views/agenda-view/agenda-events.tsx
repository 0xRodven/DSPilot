...
import { EventDetailsDialog } from "@/components/full-calendar/dialogs/event-details-dialog";
import {
  formatTime,
  getBgColor,
  getColorClass,
          ...
          >
            {groupedEvents?.map((event) => (
              <CommandItem
                key={event.id}
                className={cn(
                  "mb-2 rounded-md border p-4 transition-all hover:cursor-pointer data-[selected=true]:bg-bg data-[selected=true]:text-none",
                  {
                  ...
                  <div className="flex w-full items-center justify-between gap-4">
                    <div className="flex items-center gap-2">
                      ...
                      <div className="flex flex-col">
                        ...
                        <p className="line-clamp-1 w-1/3 text-ellipsis text-muted-foreground text-sm md:text-clip">
                          {event.description}
                        </p>
                      </div>
                    </div>
