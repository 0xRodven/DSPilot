...
import { DayViewMultiDayEventsRow } from "@/components/full-calendar/views/week-and-day-view/day-view-multi-day-events-row";
        ...
        <div className="flex-1 space-y-3">
          {currentEvents.length > 0 ? (
            <div className="flex items-start gap-2 px-4 pt-4">
              ...
              <p className="font-semibold text-sm text-t-secondary">Happening now</p>
            </div>
          ) : (
                ...
                {currentEvents.map((event) => {
                  ...
                  return (
                    <div key={event.id} className="space-y-1.5">
                      <p className="line-clamp-2 font-semibold text-sm">{event.title}</p>
