...
import { fadeIn, staggerContainer, transition } from "@/components/full-calendar/animations";
...
import { DroppableArea } from "@/components/full-calendar/dnd/droppable-area";
import { groupEvents } from "@/components/full-calendar/helpers";
import type { IEvent } from "@/components/full-calendar/interfaces";
import { CalendarTimeline } from "@/components/full-calendar/views/week-and-day-view/calendar-time-line";
import { RenderGroupedEvents } from "@/components/full-calendar/views/week-and-day-view/render-grouped-events";
import { WeekViewMultiDayEventsRow } from "@/components/full-calendar/views/week-and-day-view/week-view-multi-day-events-row";
          ...
          >
            ...
            <div className="grid flex-1 grid-cols-7 border-l">
              {weekDays.map((day, index) => (
                <motion.span
                  key={index}
                  className="py-1 text-center font-medium text-muted-foreground text-xs sm:py-2"
                ...
                >
                  ...
                  <span className="block sm:hidden">
                    ...
                    <span className="block font-semibold text-foreground text-xs">{format(day, "d")}</span>
                  </span>
          ...
          <div className="flex">
            ...
            <motion.div className="relative w-18" variants={staggerContainer}>
              {hours.map((hour, index) => (
                ...
                >
                  <div className="-top-3 absolute right-2 flex h-6 items-center">
                    {index !== 0 && (
                    ...
                    >
                      {hours.map((hour, index) => (
                        ...
                        >
                          ...
                          <div className="pointer-events-none absolute inset-x-0 top-1/2 border-b border-b-tertiary border-dashed" />
