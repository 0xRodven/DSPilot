...
import { transition } from "@/components/full-calendar/animations";
import { EventListDialog } from "@/components/full-calendar/dialogs/events-list-dialog";
...
import { useMediaQuery } from "@/components/full-calendar/hooks";
import type { ICalendarCell, IEvent } from "@/components/full-calendar/interfaces";
import { EventBullet } from "@/components/full-calendar/views/month-view/event-bullet";
import { MonthEventBadge } from "@/components/full-calendar/views/month-view/month-event-badge";
        ...
        <DroppableArea date={date} className="h-full w-full py-2">
          ...
          {showMobileMore && (
            <div className="mx-2 flex items-end justify-end">
              <span className="font-semibold text-[0.6rem] text-accent-foreground">+{showMoreCount}</span>
            </div>
          )}
