...
import { dayCellVariants } from "@/components/full-calendar/views/month-view/day-cell";
        ...
        <ModalHeader>
          <ModalTitle className="my-2">
            <div className="flex items-center gap-2">
              ...
              <p className="font-medium text-sm">Events on {format(date, "EEEE, MMMM d, yyyy")}</p>
            </div>
          </ModalTitle>
        </ModalHeader>
