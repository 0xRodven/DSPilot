...
export const ERROR_DESCRIPTIONS: Record<string, string> = {
  ...
  "Photo Defect":
    "La photo de preuve de livraison n'est pas conforme : floue, mal cadrée, ou ne montre pas clairement le colis",
  ...
  "Failed Attempts":
    "MS - Tentatives échouées - Le driver n'a pas pu effectuer la livraison (problème système ou client absent)",
  "MS - Failed Attempts":
    "MS - Tentatives échouées - Le driver n'a pas pu effectuer la livraison (problème système ou client absent)",
  ...
  "Safe Place":
    "Le lieu sûr choisi pour déposer le colis n'est pas conforme aux règles Amazon (visibilité, protection, etc.)",
