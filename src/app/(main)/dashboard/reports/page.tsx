...
import { Calendar, Download, ExternalLink, FileText, TrendingUp } from "lucide-react";
            ...
            <TabsContent value={activeTab}>
              <Card>
                <CardContent className="flex flex-col items-center justify-center py-16">
                  ...
                  <p className="font-medium text-lg text-muted-foreground">Aucun rapport disponible</p>
