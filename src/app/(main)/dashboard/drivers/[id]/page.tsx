      ...
      <div className="p-6">
        <div className="mb-6">
          <Link
            ...
            className="inline-flex items-center text-muted-foreground text-sm transition-colors hover:text-card-foreground"
          >
        ...
        <Card className="mx-auto mt-12 max-w-md">
          <CardContent className="p-6 text-center">
            ...
            <h2 className="mb-2 font-semibold text-xl">Driver non trouvé</h2>
            <p className="mb-4 text-muted-foreground">
              Ce driver n&apos;existe pas ou vous n&apos;avez pas accès à ses données.
            </p>
            <Link href="/dashboard/drivers" className="text-primary hover:underline">
    ...
    <main className="min-h-[calc(100vh-4rem)]">
      <div className="p-6">
        <div className="mb-6">
          ...
          <span className="text-card-foreground text-sm">{driverName}</span>
        </div>

        <Card className="mx-auto mt-12 max-w-md">
          <CardContent className="p-6 text-center">
            <div className="mb-4 text-4xl">📊</div>
            <h2 className="mb-2 font-semibold text-xl">Pas de données</h2>
            <p className="mb-4 text-muted-foreground">
              Aucune donnée de performance n&apos;est disponible pour cette semaine. Essayez de sélectionner une autre
              période.
            </p>
            <Link href="/dashboard/drivers" className="text-primary hover:underline">
              Retour à la liste des drivers
    ...
    <main className="min-h-[calc(100vh-4rem)]">
      <div className="p-6">
        ...
        <div className="mb-6 flex items-center">
          ...
          <span className="mx-2 text-muted-foreground">/</span>
          <span className="text-card-foreground text-sm">{driver.name}</span>
          {latestWeek && (
        ...
        <div className="mb-6">
          <DailyPerformanceChartWithCoaching driverId={id as Id<"drivers">} driverName={driver.name} />
        </div>
