    ...
    <div className="flex min-h-screen">
      ...
      <div className="relative hidden flex-col items-center justify-center overflow-hidden bg-gradient-to-br from-[#0052CC] via-[#0081FF] to-[#00C9D7] p-12 lg:flex lg:w-1/2">
        ...
        <div className="relative z-10 flex max-w-md flex-col items-center text-center">
          ...
          <h1 className="mb-4 font-bold text-4xl text-white">DSPilot</h1>

          <p className="mb-6 text-white/90 text-xl">Gérez vos performances livreurs avec intelligence</p>
          ...
          <div className="flex flex-col gap-4 text-sm text-white/80">
            <div className="flex items-center gap-3">
              ...
              <span>Suivi DWC & IADC en temps réel</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="flex h-8 w-8 items-center justify-center rounded-full bg-white/20">
                <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 20 20">
              ...
              <span>Coaching personnalisé des conducteurs</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="flex h-8 w-8 items-center justify-center rounded-full bg-white/20">
                <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 20 20">
              ...
              <span>Import simplifié des données Amazon</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-1 items-center justify-center bg-white p-8">
        <div className="w-full max-w-md">
          ...
          <SignIn appearance={clerkAppearance} forceRedirectUrl="/dashboard" signUpUrl="/sign-up" />
        </div>
      </div>
    </div>
  );
